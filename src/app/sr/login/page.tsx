/**
 * Login Page - Serbian Version (/sr/login)
 */
...
function LoginForm() {
  ...
  const callbackUrl = searchParams.get('callbackUrl') || '/sr/matches';
  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-text-secondary mt-2">{t.auth.signInToAccess}</p>
      </div>
      ...
      <div className="space-y-3 mb-6">
        ...
        >
          ...
          <span className="text-text-primary font-medium">{t.auth.continueWithGoogle}</span>
        </button>
      </div>
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-4 bg-bg text-text-muted">{t.auth.orContinueWithEmail}</span>
        </div>
      </div>
      ...
      <p className="text-center text-text-secondary text-sm mt-6">
        ...
        <Link href="/sr/register" className="text-primary hover:text-primary/80 font-medium">
          {t.auth.signUp}
        </Link>
      </p>
    </div>
...
export default function LoginPageSR() {
  return (

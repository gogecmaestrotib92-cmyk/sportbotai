 ...
 * 
 * Replaces cheap emojis with premium SVG icons throughout the app.
 * Use: <PremiumIcon name="chart" size="sm" />
 */
...
// SVG paths for each icon (using Heroicons-style design)
const ICON_PATHS: Record<IconName, React.ReactNode> = {
  ...
  basketball: (
    <>
      <circle cx="12" cy="12" r="9" />
      <path d="M12 3c2.21 0 4.21.895 5.657 2.343M12 3c-2.21 0-4.21.895-5.657 2.343M12 21c2.21 0 4.21-.895 5.657-2.343M12 21c-2.21 0-4.21-.895-5.657-2.343M3 12h18M12 3v18" />
    </>
  ),
  football: (
...
// Helper to map emoji to icon name (for gradual migration)

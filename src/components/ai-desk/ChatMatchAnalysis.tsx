                ...
                {probabilities && (
                    <div className="grid grid-cols-3 gap-2 mt-3">
                        <div className="text-center p-2 bg-white/5 rounded-lg">
                            <div className="text-lg font-bold text-white">{Math.round((probabilities.homeWin || 0) * 100)}%</div>
                        ...
                        {probabilities.draw !== undefined && probabilities.draw !== null && (
                            <div className="text-center p-2 bg-white/5 rounded-lg">
                                <div className="text-lg font-bold text-white">{Math.round((probabilities.draw || 0) * 100)}%</div>
                                <div className="text-xs text-text-muted">Draw</div>
                            </div>
                        )}
                        <div className="text-center p-2 bg-white/5 rounded-lg">
                            <div className="text-lg font-bold text-white">{Math.round((probabilities.awayWin || 0) * 100)}%</div>

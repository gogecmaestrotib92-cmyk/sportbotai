...
export default function SportLeagueSelector({
  sports,
  selectedSport,
  selectedLeague,
  leagueMatchCounts,
  ...
  // Get trending leagues (top 4 by match count)
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs text-text-muted">
          {currentSport.leagues.length} leagues
        </span>
      </div>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-text-muted">
                  {matchCount > 0 ? (
                    <span className="text-accent">{matchCount} matches</span>
                  ) : (

...
const testimonials = [
  {
    id: 1,
    name: 'Marcus T.',
    role: 'Content Creator · 6 months on Pro',
    text: 'I used to spend 2 hours every Saturday morning researching matches for my preview videos. Now it takes 5 minutes. My audience thinks I hired a research team.',
    rating: 5,
  },
  {
    id: 2,
    ...
    text: 'First week using SportBot, I spotted a 3.8% edge on an underdog draw the market completely missed. No tips, no BS—just data I can actually trust.',
    rating: 5,
  },
  {
    id: 3,
    name: 'David R.',
    role: 'Casual Fan · Free → Pro in 2 weeks',
    text: 'Tried the free analysis on a Saturday match. Within 60 seconds I understood more about that game than 3 pundits explained in 45 minutes. Upgraded the same weekend.',
    rating: 5,
  },
  {
    id: 4,
    name: 'Emma L.',
    role: 'Fantasy Player · 847 analyses run',
    text: 'Injury reports, form streaks, and AI chat for any question—I went from middle of the pack to top 3 in my fantasy league this season. One tool replaced four apps.',
    rating: 5,
  },
  {
    id: 5,
    name: 'James P.',
    role: 'Podcast Host · 14 months on Premium',
    text: 'My podcast prep went from 4 hours to 45 minutes per episode. Guests think I\'m a football genius. I just ask SportBot the right questions 60 seconds before recording.',
    rating: 5,
  },
];

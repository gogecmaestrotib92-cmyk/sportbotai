    ...
    <section className="bg-bg section-container relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 max-w-5xl mx-auto relative">
        ...
        <div className="card-glass p-5 sm:p-6 relative border-2 border-accent/50 md:scale-105">
          ...
          <Link
            href={pricingHref}
            className="block w-full py-3 px-6 rounded-btn font-semibold transition-all duration-200 bg-accent-dark text-white hover:bg-accent min-h-[48px] text-center"
          >
        ...
        <div className="card-glass p-5 sm:p-6 relative border-2 border-accent/30">
          ...
          <Link
            href={pricingHref}
            className="block w-full py-3 px-6 rounded-btn font-semibold transition-all duration-200 bg-accent-dark/80 hover:bg-accent-dark text-white border border-accent/30 min-h-[48px] text-center"
          >
